...
#define EXTENDED_BLOCKS_PER_LUN		88 //坏块替换，不知是否可用，pending
...
#define BAD_BLOCK_MARK_PAGE0		0 //for what? pending									//first row of a block
#define BAD_BLOCK_MARK_PAGE1		(ROWS_PER_MLC_BLOCK - 1) //for what? pending					//last row of a block
...
#define	NSC_MAX_CHANNELS				8 //pending 可能出错
